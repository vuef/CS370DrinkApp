...
public class DrinkOfTheDay extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        APIClient.getDrinkProvider()
                .getDOTDRecipeById("14842")//drinkItem.drinkId)
        ...
        drinkImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DrinkOfTheDay.this.getActivity().getBaseContext(), DOTDSingle.class);
                intent.putExtra("RECIPE_ID", "14842");
