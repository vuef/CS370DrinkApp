...
public class Main extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Navigation Drawer
        //Drink of the day fragment
        DrinkOfTheDay frag = new DrinkOfTheDay();
        final FragmentManager manager= getFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        transaction.add(R.id.InnerRelativeLayout,frag, "DrinkOfTheDay");
        transaction.commit();
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                APIClient.getDrinkProvider()
                        .getDrinksByDrinkName(searchInput.getText().toString())
                        ...
                        .subscribe(new Subscriber<DrinkSearchResultModel>() {
                            ...
                            public void onNext(DrinkSearchResultModel searchResultModel) {
                                searchResultsList.setAdapter(new DrinkListAdapter(Main.this, searchResultModel.drinks));
                            }
                ...
                try {
                    ...
                    ft.remove(manager.findFragmentByTag("DrinkOfTheDay"));
                    ft.commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_favorites) {
            ...
            intent = new Intent(Main.this, DOTDSingle.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
