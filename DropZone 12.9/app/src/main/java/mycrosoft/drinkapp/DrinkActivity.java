...
public class DrinkActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String dotd = extras.getString("RECIPE_ID");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_favorites) {
            intent = new Intent(DrinkActivity.this, Favorites.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            DrinkActivity.this.startActivity(intent);
        } else if (id == R.id.nav_WCIM) {
            intent = new Intent(DrinkActivity.this, WhatCanIMakeActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            DrinkActivity.this.startActivity(intent);
        }else if (id == R.id.nav_random){
            intent = new Intent(DrinkActivity.this, DOTDSingle.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            intent.putExtra("RECIPE_ID", drink);
            DrinkActivity.this.startActivity(intent);
        }else if (id == R.id.nav_Search) {
            intent = new Intent(DrinkActivity.this, Main.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            DrinkActivity.this.startActivity(intent);
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
