...
public class WhatCanIMakeActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    APIClient.getDrinkProvider()
                            ...
                            .subscribe(new Subscriber<DrinkSearchResultModel>() {
                                ...
                                public void onNext(DrinkSearchResultModel searchResultModel) {
                                    ...
                                    {
                                        //ingreds.setAdapter(new WCIMStoredIngredListAdapter(WhatCanIMakeActivity.this, null));
        ...
        /*ingreds.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            // When the recipe item is clicked, the following code is executed
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //for (String s : stored_ingredients) {
                 //   if (Objects.equals(s, stored_ingredients.get(position))) {
                        stored_ingredients.remove(position);
                  //      DB.deleteIngredient(DB, stored_ingredients.get(position));
                        Toast.makeText(getBaseContext(), "Deleted ingredient: " + stored_ingredients.get(position), Toast.LENGTH_LONG).show();
                   // }
               // }
               // ingreds.setAdapter(new WCIMStoredIngredListAdapter(WhatCanIMakeActivity.this, stored_ingredients));
            }
